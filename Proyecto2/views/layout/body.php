...
<body>
    ...
    <div class="row" style="margin-right: 0px;">
        <div class="col-lg-4 px-0 h-470 opacity-black bg-img" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),  rgba(0, 0, 0, 0.5)), url(../../assets/img/sueter_inicio.jpg);">
        ...
        <div class="col-lg-4 px-0 h-470 opacity-black bg-img" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),  rgba(0, 0, 0, 0.5)), url(../../assets/img/sudaderas.jpg);">
            <div class="card bg-transparent border-none h-100">
                <div class="card-body d-flex align-items-end justify-content-center">
        ...
        <div class="col-lg-4 px-0 h-470 opacity-black bg-img" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),  rgba(0, 0, 0, 0.5)), url(../../assets/img/playera_inicio.jpg);">
            <div class="card bg-transparent border-none h-100">
                <div class="card-body d-flex align-items-end justify-content-center">
            ...
            <div class="container text-center">
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 h-400">
                        <div class="card h-100 border-none" style="background-image: linear-gradient(rgba(0, 0, 0, 0.3),  rgba(0, 0, 0, 0.3)), url(../../assets/img/img_body2.jpg); border-radius: 0px;">
                    ...
                    <div class="card h-100 border-none bg-img" style="background-image: url(../../assets/img/img_body.png); border-radius: 0px;">
                ...
                <div class="row">
                    <div class="col-lg-8 h-400 mb-5">
                        <div class="card h-100 w-100 border-none bg-img" style="background-image: linear-gradient(rgba(0, 0, 0, 0.2),  rgba(0, 0, 0, 0.2)), url(../../assets/img/img_body5.jpg); border-radius: 0px;">
                    ...
                    <div class="col-lg-4 h-400">
                    <div class="card h-100 border-none bg-img"" style="background-image: url(../../assets/img/deportivo.jpg); border-radius: 0px;">
